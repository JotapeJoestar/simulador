...
<h3 style="position:absolute;top:1000px;color:white;"><?php echo $_SESSION['username'];  ?></h3>

  
   <a href="../vista/inicio.php">Inicio</a>
  <a href="../vista/update_data.php">Actualizar datos </a>
  <a href="../vista/edit_usuario.php">Crear o editar usuario</a>



<div class="containerlog">
<p class="btnexit"><a  href="../model/salir.php">Cerrar</a></p>	
