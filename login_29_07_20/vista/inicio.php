...
<div class="ini">
  <div class="limiter">
    ...
    <tr>
        <td>
          <a href="crear.php" class="actionsis" style="background-image: url('../imagenes/index/CREATE.jpg');"></a>
        </td>
        <td>
          <a href="eliminar.php" class="actionsis" style="background-image: url('../imagenes/index/DELETE.jpg');"></a>
        </td>
...
<?php if (isset($o_pozo)) {
 ...
 ?>
          ...
          <a href="../../../simul/indexs.php?idpozo=<?php echo $o_pozo; ?>" style="background-image: url('../imagenes/index/DRILLING.jpg');position:absolute;top:205px;left:382px;"  class="actionsis"></a>
    ...
    <div class='modal-content1'>
        ...
        <form action="../model/op_pozo/o_segundo.php" method="POST" class="inputform">
          <input type="hidden" name="usuarioid2" id="usuarioid2" value="<?php echo $_SESSION['username']; ?>">
            <table>
                <tr>
                    <th>Nombre de bombas|</th>
                    <th>Tipo de bombas|</th>
                    <th>Diámetro del revestimiento (in)|</th>
                    <th>Longitud de la carrera(in)|</th>
                    <th>Eficiencia(%)</th>
                    <th>Diámetro del pistón (in) |</th>
                    <th>Entrada manual(bbls/stk)|</th>
                    <th>Producción (bbls/Stk))|</th>
                    <th>MaxPres (psi)</th>
                    <th> </th>
                </tr>
                <tr>
...
<tr>
  <th>Capacitación          |</th>
  <th>Zona               |</th>
  <th>profundidad de inicio          |</th>
  <th>Profundidad final        |</th>
  <th>Presión de formación|</th>
  <th>Composición de la roca
|</th>
  <th></th>
</tr>
                ...
                <tr>
                    <td>
                        ...
                        <select id="componente_bha" name="componente_bha" onchange="enviar_valoresbha(this.value);">
                            ...
                            <option value="DrillPipe">Tubería de perforación</option>
                            <option value="HWDP">HWDP</option>
                            <option value="Drill Collar">Collar de taladro</option>
                        </select>
                    </td>
                    <td>
...
<tr>
  <th>
volumen de la línea de sufragio(bbl)</th>
  <td><input type="text" id="confi4" name="confi4" value="<?php echo  $vsl ;  ?>"></td>
</tr>

<tr>
  <th>Perforación constante</th>
  ...
  <button id='myBtn2' class='datos myBtn'></button>
  <div id='myModal2' class='modal1 myModal'>
    <div class='modal-content1'>
      <span class='close1'>&times;</span>
      <p><b></b>
