...
<form action="" method="POST"  class="" > 
  <table >
    <tr>
      <td>
  <a href="inicio_in.php" class="actionsis"style="background-image: url('../imagenes/index/EDIT.jpg');border:1px solid black;"></a></td>
  <td>
    <a href="crear_in.php" class="actionsis" style="background-image: url('../imagenes/index/CREATE.jpg');border:1px solid black;"></a>
    </td>
  </tr>
  </table>
</form>
...
while ($row_well=mysqli_fetch_array($select_pozo)) {
 ...
 ?>
  ...
  <input type="hidden" name="usernameglobal" id="usernameglobal" value="<?php echo $_SESSION['username']; ?>">
    ...
    <td><input type="submit" name="eliminarp" class="eliminar" value="Delete"></td>
